...
async def on_message(message: discord.Message):
    ...
    elif (message.content.lower().__contains__("fuck you") or message.content.lower().__contains__("sybau") or "gtfo" in message.content.lower() or "bitch" in message.content.lower()) and not message.author.id == 1421908020601946297:
